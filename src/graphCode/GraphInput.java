...
public class GraphInput {
    ...
    public static void main (String args[]) {
          ...
          LoadSimpleGraph(G, "C:\\Users\\Radhika AS\\workspace\\TCSS543\\rando.txt");
          for (i= G.vertices(); i.hasNext(); ) {
              v = (Vertex) i.next();
              System.out.println("found vertex " + v.getName());
          }
          /*         for(Map.Entry<String, Vertex> e: h.entrySet()){
        	  String s = e.getKey();
        	  Vertex v = e.getValue();
        	  System.out.println("String "+s+" Veretx name "+v.getName());
        	  */
