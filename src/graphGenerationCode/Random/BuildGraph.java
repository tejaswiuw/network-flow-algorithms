...
public class BuildGraph {
	private void BuildGraph1(String fileName, String directory, int vertices, int dense, int maxCapacity, int minCapacity)
	{
	...
	public static void main(String[] args){
		...
		b.BuildGraph1("graph.txt","C:\\Users\\Radhika AS\\workspace\\TCSS543\\",20,50,100,50);
	}
} 